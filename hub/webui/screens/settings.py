...
_S = {
    "en": {
        ...
        "path_set": "Set",
        "lang_name": "Language",
        "acct_meta": "Player ID {id}",
        "ready_steam": "Account", "ready_bodycam": "Bodycam", "ready_servers": "Servers",
    ...
    "de": {
        ...
        "path_set": "Setzen",
        "lang_name": "Sprache",
        "acct_meta": "Spieler-ID {id}",
        "ready_steam": "Konto", "ready_bodycam": "Bodycam", "ready_servers": "Server",
    ...
    "es": {
        ...
        "path_set": "Fijar",
        "lang_name": "Idioma",
        "acct_meta": "ID de jugador {id}",
        "ready_steam": "Cuenta", "ready_bodycam": "Bodycam", "ready_servers": "Servidores",
    ...
    "fr": {
        ...
        "path_set": "Définir",
        "lang_name": "Langue",
        "acct_meta": "ID du joueur {id}",
        "ready_steam": "Compte", "ready_bodycam": "Bodycam", "ready_servers": "Serveurs",
    ...
    "pt": {
        ...
        "path_set": "Definir",
        "lang_name": "Idioma",
        "acct_meta": "ID do jogador {id}",
        "ready_steam": "Conta", "ready_bodycam": "Bodycam", "ready_servers": "Servidores",
    ...
    "ru": {
        ...
        "path_set": "Задать",
        "lang_name": "Язык",
        "acct_meta": "ID игрока {id}",
        "ready_steam": "Аккаунт", "ready_bodycam": "Bodycam", "ready_servers": "Серверы",
    ...
    "zh": {
        ...
        "lang_name": "语言",
        "acct_meta": "玩家 ID {id}",
        "ready_steam": "账号", "ready_bodycam": "Bodycam", "ready_servers": "服务器",
